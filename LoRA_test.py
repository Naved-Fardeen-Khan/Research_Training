...
print("Extracting logs and generating loss curve plot...")
...
plt.plot(train_steps, train_loss, label="Training Loss", color="blue", alpha=0.6, linewidth=2)

# Only plot the eval line if we actually took the exams
if eval_steps: 
    plt.plot(eval_steps, eval_loss, label="Evaluation (Test) Loss", color="red", marker="o", linewidth=2)
